...
class SupportVectorMachine(AbstractModel):
    def __init__(self,
                 ...
                 fpath = None):
        '''
        The SupportVectorMachine model class
    ...
    def _generate_model(self, kernel = "rbf", C = 1.0):
        '''
    ...
    def _load_model(self, fpath):
        ...
        if os.path.exists(fpath):
            try:
                model = joblib.load(os.path.join(fpath, 'SVM_model.pkl'))
            except:
    ...
    def save_model(self, fpath):
        ...
        if not os.path.exists(fpath):
            os.makedirs(fpath)
        joblib.dump(self.model, os.path.join(fpath, 'SVM_model.pkl'))
        print("The SupportVectorMachine Model save in \n  {}".format(os.path.join(fpath, 'SVM_model.pkl')))
