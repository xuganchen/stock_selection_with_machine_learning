...
class GradientBoostingMachine(AbstractModel):
    def __init__(self,
                 X_train = None,
                 Y_train = None,
                 X_test = None,
                 ...
                 fpath = None):
        '''
        The GradientBoostingMachine model class
    ...
    def _load_model(self, fpath):
        ...
        if os.path.exists(fpath):
            try:
                model = joblib.load(os.path.join(fpath, 'GBM_model.pkl'))
            except:
    ...
    def save_model(self, fpath):
        ...
        if not os.path.exists(fpath):
            os.makedirs(fpath)
        joblib.dump(self.model, os.path.join(fpath, 'GBM_model.pkl'))
        print("The GradientBoostingMachine Model save in \n  {}".format(os.path.join(fpath, 'GBM_model.pkl')))
