...
class Bagging(AbstractModel):
    ...
    def _load_model(self, fpath):
        ...
        if os.path.exists(fpath):
            try:
                model = joblib.load(os.path.join(fpath, 'BAG_model.pkl'))
            except:
    ...
    def save_model(self, fpath):
        ...
        if not os.path.exists(fpath):
            os.makedirs(fpath)
        joblib.dump(self.model, os.path.join(fpath, 'BAG_model.pkl'))
        print("The Bagging Model save in \n  {}".format(os.path.join(fpath, 'BAG_model.pkl')))
